...
>
  ...
  <div className="container px-4 md:px-6">
    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
      ...
      <div className="space-y-2">
        <h4 className="text-sm font-semibold text-gray-700">Important Links</h4>
        <ul className="space-y-2 text-sm">
          <li>
            <Link href="/privacyPolicy" className="text-gray-500 hover:text-red-600">
              Privacy Policy
            </Link>
          </li>
          <li>
            <Link href="/termsAndConditions" className="text-gray-500 hover:text-red-600">
              Terms and Conditions
            </Link>
          </li>
          <li>
            <Link href="/safetyStandards" className="text-gray-500 hover:text-red-600">
              Safety Standards
            </Link>
          </li>
        </ul>
